...
python3 cma-es-hyperparameter-optimization.py 5 5 3 & 
python3 cma-es-hyperparameter-optimization.py 5 5 4 & 
python3 cma-es-hyperparameter-optimization.py 5 5 8 & 
